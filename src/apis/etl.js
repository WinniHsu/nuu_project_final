...
export const apiUpdateAuthGroup =(params) => req('post','/api/etlcontroller/saveauth',params);
...
export const apiDataclean =(params,tableName) => req('post','/api/etlcontroller/dataclean/'+tableName,params);
